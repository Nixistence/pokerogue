...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.SENTRET, 2, false, false, false, "Scout Pokémon", Type.NORMAL, null, 0.8, 6, Abilities.HUGE_POWER, Abilities.MINDS_EYE, Abilities.PIXILATE, 215, 35, 46, 34, 35, 45, 20, 255, 70, 43, GrowthRate.MEDIUM_FAST, 50, false),
    new PokemonSpecies(Species.FURRET, 2, false, false, false, "Long Body Pokémon", Type.NORMAL, null, 1.8, 32.5, Abilities.HUGE_POWER, Abilities.MINDS_EYE, Abilities.PIXILATE, 570, 55, 135, 135, 55, 55, 135, 90, 70, 145, GrowthRate.MEDIUM_FAST, 50, false),
...
export const starterPassiveAbilities = {
  ...
  [Species.SENTRET]: Abilities.HUGE_POWER,
